...
public class WorldTweaksExtension extends ClientModuleExtension {
    ...
    public ToggleOption glintParentToggle = new ToggleOption(parent, "Enchant", "Recolor the enchantment glint", false);
    ...
    public ToggleOption damageTintToggle = new ToggleOption(parent, "Damage", "Recolor the red hurt flash on entities", false);
