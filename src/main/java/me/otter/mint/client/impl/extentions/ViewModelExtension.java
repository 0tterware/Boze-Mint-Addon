...
public class ViewModelExtension extends ClientModuleExtension {
    ...
    public final SliderOption mainSwing = new SliderOption(parent, "ProgressM", "Offsets your main hand's swing progress.", 0.0, -16.0, 16.0, 0.01);
    public final SliderOption offSwing = new SliderOption(parent, "ProgressO", "Offsets your off hand's swing progress.", 0.0, -16.0, 16.0, 0.01);
